(function() {
    ...
    function listReview($location, $routeParams, ProductService, UserService, ReviewService, $sce) {
        ...
        vm.stars = function(rating) {
            if(rating == 0) {
                return $sce.trustAsResourceUrl('/../../resources/stars/star-0.jpg');
            }
            if(rating == 1) {
                return $sce.trustAsResourceUrl('/../../resources/stars/star-1.jpg');
            }
            if(rating == 2) {
                return $sce.trustAsResourceUrl('/../../resources/stars/star-2.jpg');
            }
            if(rating == 3) {
                return  $sce.trustAsResourceUrl('/../../resources/stars/star-3.jpg');
            }
            if(rating == 4) {
                return $sce.trustAsResourceUrl('/../../resources/stars/star-4.jpg');
            }
            if(rating == 5) {
                return $sce.trustAsResourceUrl('/../../resources/stars/star-5.jpg');
            }
        }
